            ...
            <div class="col-md-3 col-sm-3">
             ...
             <div class="col-md-8 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">Khách sạn đã đặt </h5>
                <div class="my_vehicles_list">
                  <ul class="vehicle_listing">
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          <h4 style="color:red">Mã đặt phòng. &nbsp;<?php echo htmlentities($result->BookingNumber);?></h4>
                          ...
                          { ?>
                            <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Đã nhận phòng</a>
                  ...
                  <h5 align="center" style="color:red">Bạn chưa đặt khách sạn nào</h5>
                  <?php 
                } ?>
              </ul>
            </div>
